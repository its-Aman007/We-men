  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className={`border border-gray-300 pl-5 py-3 my-5 ${ShowFilter ? '' : 'hidden'} ${showType ? '' : 'hidden'} sm:block`}>
          ...
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
                <p className='flex gap-2'>
                  <input className='w-3' type='checkbox' value={'Top-wear'} onChange={toggleSubcategory} checked={subcategory.includes('Top-wear')} /> Top-wear
                </p>
                <p className='flex gap-2'>
                  <input className='w-3' type='checkbox' value={'Bottom-wear'} onChange={toggleSubcategory} checked={subcategory.includes('Bottom-wear')} /> Bottom-wear
                </p>
                <p className='flex gap-2'>
                  <input className='w-3' type='checkbox' value={'Winter-wear'} onChange={toggleSubcategory} checked={subcategory.includes('Winter-wear')} /> Winter-wear
                </p>
          </div>
        </div>
      </div>
