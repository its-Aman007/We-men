  ...
  return (
    <div className='flex flex-col sm:flex-row justify-around gap-12 sm:gap text-center py-20 text-xs sm:text-sm md:text-base text-gray'>
        <div>
            ...
            <p className='mt-2'>Every order is packed fresh and ready to enjoy.</p>
        </div>

        <div>
            <img src={assets.quality_icon} className='w-12 m-auto mb-5' alt="" />
            <p className='font-semibold'>Careful Packaging</p>
            <p className='mt-2'>Treats and meals arrive ready for your table.</p>
        </div>
